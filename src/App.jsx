    ...
    <div className="page-container">
      <Navbar className='nav'>
        <Container>
          ...
          <Navbar.Collapse>
            <Nav  >
              <Nav.Link href="#home" style={{color:"white" ,marginLeft:"40px"}} id='anchor' data-aos="fade-down" data-aos-delay="200" data-aos-duration="800">Home</Nav.Link>
              <Nav.Link href="#features" style={{color:"white"}} id='anchor'  data-aos="fade-down" data-aos-delay="200" data-aos-duration="1400">Contact</Nav.Link>
              <Nav.Link href="#pricing" style={{color:"white"}} id='anchor'  data-aos="fade-down" data-aos-delay="200" data-aos-duration="2000">Gallery</Nav.Link>
              <Nav.Link href="#pricing" style={{color:"white"}} id='anchor'  data-aos="fade-down" data-aos-delay="200" data-aos-duration="2500">About Us</Nav.Link>
              <Nav.Link href="#pricing" style={{color:"white"}} id='anchor'  data-aos="fade-down" data-aos-delay="200" data-aos-duration="3000">Testimonial</Nav.Link>
...
<div class="🤚">
	...
	<div class="👍"></div>
        ...
        <span class="loader" style={{marginLeft:"830px"}}></span>
        <Row className="g-4">
          {cardsData.map((card) => (
